  ...
  return /*#__PURE__*/(0,jsx_runtime.jsxs)(theme/* Box */.xu, {
    ...
    children: [/*#__PURE__*/jsx_runtime.jsx(BottomBorder, {}), /*#__PURE__*/(0,jsx_runtime.jsxs)(theme/* Container */.W2, {
      ...
      children: [/*#__PURE__*/jsx_runtime.jsx(mobile_navigation_SectionLabel, {
        ...
        wrap: true,
        children: menu_items.map(item => /*#__PURE__*/jsx_runtime.jsx(SectionLink, mobile_navigation_objectSpread({}, item), item.name))
      })]
    })]
  });
};
...
const HeaderMain = /*#__PURE__*/(0,react.forwardRef)((_ref, ref) => {
  ...
  const [modalIsOpen, toggleModalIsOpen] = (0,use_cycle/* useCycle */.n)(false, true);
  ...
  async function toggleQuoteModal(e) {
    e.preventDefault();
    toggleModalIsOpen();
  }
...
const Modal = (_ref) => {
  let {
    ...
    layoutId
      ...
      props = _objectWithoutProperties(_ref, ["width", "opens", "children", "layoutId"]);
...
/* harmony export */ });
/* harmony import */ var react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(85893);
/* harmony import */ var _button__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(75843);
/* harmony import */ var _modal_src_modal__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(95778);
/* harmony import */ var _temp_quote_form__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(20494);
...
const QuoteButton = (_ref) => {
  ...
  return /*#__PURE__*/react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx(_modal_src_modal__WEBPACK_IMPORTED_MODULE_3__/* .Modal */ .u, {
    opens: ({
      modalIsOpen,
      toggleModal
    }) => /*#__PURE__*/react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx(_temp_quote_form__WEBPACK_IMPORTED_MODULE_2__/* .TempQuoteForm */ .D, {
      toggle: toggleModal,
      active: modalIsOpen
    }),
    children: ({
      toggleModal
    }) => /*#__PURE__*/react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx(_button__WEBPACK_IMPORTED_MODULE_1__/* .Button */ .zx, _objectSpread(_objectSpread({
      onClick: toggleModal
    }, props), {}, {
...
const WorkaroundForm = (0,dynamic.default)(() => __webpack_require__.e(/* import() */ 4039).then(__webpack_require__.bind(__webpack_require__, 27273)).then(res => res.NetlifyWorkaroundForm), {
  ...
  loadableGenerated: {
    ...
    modules: ["../components/temp-quote-form/src/temp-quote-form.tsx -> " + '@components/netlify-workaraound-form']
  }
});
...
const TempQuoteForm = (_ref) => {
  let {
    ...
    active
      ...
      props = _objectWithoutProperties(_ref, ["toggle", "modalLayoutId", "active"]);
      ...
      children: [router.query['success'] && /*#__PURE__*/jsx_runtime.jsx(SuccessBackground, {
        ...
        children: [/*#__PURE__*/(0,jsx_runtime.jsxs)(theme/* Box */.xu, {
          ...
          children: [/*#__PURE__*/(0,jsx_runtime.jsxs)(theme/* Flex */.kC, {
            ...
            errors: errors,
            render: (textMaskRef, props) => /*#__PURE__*/jsx_runtime.jsx(theme/* Input */.II, _objectSpread(_objectSpread(_objectSpread({}, register('phone')), {}, {
              ref: node => {
                textMaskRef(node);

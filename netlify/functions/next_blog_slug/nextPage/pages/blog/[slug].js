...
const Img = (0,_theme__WEBPACK_IMPORTED_MODULE_3__/* .styled */ .zo)(react_datocms__WEBPACK_IMPORTED_MODULE_7__.Image, {
  position: 'relative',
  width: '100vw',
  mx: '-50vw',
  left: '50%',
...
const Blog = ({
  ...
  return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_components_layout__WEBPACK_IMPORTED_MODULE_2__/* .Layout */ .A, {
    canonicalPath: `https://www.aomail.com.au/blog/${data.slug}` //@ts-expect-error
    ,
    ...
    children: [/*#__PURE__*/react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx(_theme__WEBPACK_IMPORTED_MODULE_3__/* .Box */ .xu, {
      ...
      children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_theme__WEBPACK_IMPORTED_MODULE_3__/* .Container */ .W2, {
        ...
        children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_theme__WEBPACK_IMPORTED_MODULE_3__/* .ColumnWrapper */ .fh, {
          ...
          children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_theme__WEBPACK_IMPORTED_MODULE_3__/* .Column */ .sg, {
            css: {
              flex: '1 1',
              display: 'flex',
              flexFlow: 'column nowrap'
...
async function getStaticProps({
  ...
  function appendOrdinal(number) {
    return number + suffixes[englishOrdinalRules.select(number)];
  }

  const date = new Date(blogArticle.updatedAt);
  const lastUpdated = `${appendOrdinal(date.getDate())} ${date.toLocaleString('default', {
    month: 'long'
  })} ${date.getFullYear()}`;
  return {
    props: {
      data: _objectSpread(_objectSpread({}, blogArticle), {}, {
        lastUpdated
      })
    }
  };
...
/* harmony import */ var next_dist_build_webpack_loaders_next_serverless_loader_page_handler__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(99436);
      ...
      const compMod = __webpack_require__(14408)
...
/******/ 		var __webpack_exports__ = __webpack_require__.O(undefined, [7057,4475,168,7109,7099,6071,5026,3735,5172,1428,3473,5252,9566,5320,3608,7522,7615,7589,1587,6895,7289,3902,1930], function() { return __webpack_require__(34330); })

...
module.exports = global.fetch = global.fetch || (
	typeof process=='undefined' ? r(__webpack_require__(19295)) : (function(url, opts) {
		return r(__webpack_require__(31515))(String(url).replace(/^\/\//g,'https://'), opts);
	})
);
...
__webpack_require__.d(__webpack_exports__, {
  "Z": function() { return /* binding */ esm_node_v4; }
});

// EXTERNAL MODULE: external "crypto"
var external_crypto_ = __webpack_require__(76417);

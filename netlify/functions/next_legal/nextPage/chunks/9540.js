...
var es_value = __webpack_require__(79585);
// EXTERNAL MODULE: ./node_modules/framer-motion/dist/es/value/utils/is-motion-value.js
var is_motion_value = __webpack_require__(52178);
...
;// CONCATENATED MODULE: ./node_modules/framer-motion/dist/es/animation/animate.js
...
function animate(from, to, transition) {
    ...
    var value = (0,is_motion_value/* isMotionValue */.i)(from) ? from : (0,es_value/* motionValue */.B)(from);
...
function createCrossfader() {
     ...
     */
    var progress = (0,es_value/* motionValue */.B)(1);
    var options = {
        lead: undefined,
        follow: undefined,
    ...
    function startCrossfadeAnimation(target, transition) {
        ...
        return animate(progress, target, (0,tslib_es6.__assign)((0,tslib_es6.__assign)({}, transition), { onUpdate: onUpdate, onComplete: function () {
                if (!hasUpdated) {
                    progress.set(target);
                    /**

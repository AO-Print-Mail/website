...
__webpack_require__.d(__webpack_exports__, {
  "default": function() { return /* binding */ create_quote; }
});

// EXTERNAL MODULE: ./node_modules/isomorphic-unfetch/index.js
var isomorphic_unfetch = __webpack_require__(18079);
;// CONCATENATED MODULE: ./src/components/quote-form/src/scripts/newQuote.tsx

const serviceTypes = ['print', 'mail', 'fulfilment', 'callback'];
async function newQuote(quote) {
  const quotePayload = await fetch('/api/create-quote', {
    method: 'POST',
    body: JSON.stringify(quote)
  }).then(res => res.json()).catch(err => err.error);
  return quotePayload;
}
// EXTERNAL MODULE: ./node_modules/uuid/dist/esm-node/v4.js + 4 modules
var v4 = __webpack_require__(32259);
;// CONCATENATED MODULE: ./src/pages/api/create-quote.ts
...
/* harmony default export */ var create_quote = ((req, res) => {
  if (req.method === 'POST') {
    if (req.body) {
      const _JSON$parse = JSON.parse(req.body),
            {
        service_id
      } = _JSON$parse,
            quote = _objectWithoutProperties(_JSON$parse, ["service_id"]);
      ...
      if (service_id && serviceTypes.find(id => id === service_id)) {
        ...
        res.status(400).json({
          error: 'The service type is invalid'
        });
      }
    } else {
      res.status(400).json({
...
/* harmony import */ var next_dist_build_webpack_loaders_next_serverless_loader_api_handler__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(88277);
      ...
      processEnv([{"path":".env.local","contents":"NEXT_DATOCMS_GRAPHQL_URL=https://graphql.datocms.com\nNEXT_DATOCMS_API_TOKEN=34f84f6a916143bb1c5cc6db6e455c\nNEXT_PUBLIC_URL=https://offers.aomail.com.au\n"}])
        ...
        const apiHandler = (0,next_dist_build_webpack_loaders_next_serverless_loader_api_handler__WEBPACK_IMPORTED_MODULE_2__/* .getApiHandler */ .Y)({
          pageModule: __webpack_require__(97545),
...
/******/ 		var __webpack_exports__ = __webpack_require__.O(undefined, [7057,715,7802,1428], function() { return __webpack_require__(39258); })
...
/******/ 			__webpack_require__.e(715);
/******/ 			__webpack_require__.e(7802);

...
/* harmony export */ });
/* unused harmony exports sortByTreeOrder, stopAnimation */
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(70655);
/* harmony import */ var _animation_utils_transitions_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(95507);
/* harmony import */ var _setters_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(13311);
/* harmony import */ var _variants_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(49396);
...
function animateTarget(visualElement, definition, _a) {
    ...
    for (var key in target) {
        ...
        var animation = (0,_animation_utils_transitions_js__WEBPACK_IMPORTED_MODULE_2__/* .startAnimation */ .b8)(key, value, valueTarget, (0,tslib__WEBPACK_IMPORTED_MODULE_1__.__assign)({ delay: delay }, transition));
...
"use strict";
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "GJ": function() { return /* binding */ checkTargetForNewValues; },
/* harmony export */   "P$": function() { return /* binding */ getOrigin; },
/* harmony export */   "CD": function() { return /* binding */ setTarget; }
/* harmony export */ });
...
/* harmony import */ var style_value_types__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(29400);
/* harmony import */ var _utils_is_numerical_string_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(7617);
/* harmony import */ var _utils_resolve_value_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(51256);
/* harmony import */ var _value_index_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(79585);
/* harmony import */ var _dom_value_types_animatable_none_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(16137);
/* harmony import */ var _dom_value_types_find_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(94131);
/* harmony import */ var _variants_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(49396);
...
function setMotionValue(visualElement, key, value) {
    if (visualElement.hasValue(key)) {
        ...
        visualElement.addValue(key, (0,_value_index_js__WEBPACK_IMPORTED_MODULE_0__/* .motionValue */ .B)(value));
    }
}
function setTarget(visualElement, definition) {
    var resolved = (0,_variants_js__WEBPACK_IMPORTED_MODULE_1__/* .resolveVariant */ .x5)(visualElement, definition);
    var _a = resolved
    ...
    for (var key in target) {
        var value = (0,_utils_resolve_value_js__WEBPACK_IMPORTED_MODULE_3__/* .resolveFinalValueInKeyframes */ .Y)(target[key]);
...
function checkTargetForNewValues(visualElement, target, origin) {
    ...
    for (var i = 0; i < numNewValues; i++) {
        ...
        if (value === undefined || value === null)
            continue;
        if (typeof value === "string" && (0,_utils_is_numerical_string_js__WEBPACK_IMPORTED_MODULE_4__/* .isNumericalString */ .P)(value)) {
            // If this is a number read as a string, ie "0" or "200", convert it to a number
            value = parseFloat(value);
        }
        else if (!(0,_dom_value_types_find_js__WEBPACK_IMPORTED_MODULE_5__/* .findValueType */ .c)(value) && style_value_types__WEBPACK_IMPORTED_MODULE_6__/* .complex.test */ .P.test(targetValue)) {
            value = (0,_dom_value_types_animatable_none_js__WEBPACK_IMPORTED_MODULE_7__/* .getAnimatableNone */ .T)(key, targetValue);
        }
        visualElement.addValue(key, (0,_value_index_js__WEBPACK_IMPORTED_MODULE_0__/* .motionValue */ .B)(value));
...
/* unused reexport */ __webpack_require__(16071)

export const fontFace = [
  ...
  /* Basic latin without numbers - preloaded */
  {
    ...
    fontDisplay: 'swap',
    src:
      'url("/fonts/ao-rcltsmbld/ao-rcltsmb-alph.woff2") format("woff2"), url("/fonts/ao-rcltsmbld/ao-rcltsmb-alph.woff") format("woff"), url("/fonts/ao-rcltsmbld/ao-rcltsmb-alph.ttf") format("truetype")',

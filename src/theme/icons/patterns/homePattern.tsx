...
export const HomePattern = createIcon({
  viewBox: '0 0 491 678',
  displayName: 'HomePattern',
  defaultProps: {
    title: 'Direct Mail and printing abstract art',
    description:
      'A neo-geometric pattern visualising envelopes and folded paper.',
    role: 'img',
  },
  path: (
    <>
      <g opacity=".9">
        ...
        />
        <path fill="#B6DDF6" d="M429 431.5v61.3h-61.3l61.3-61.3z" />
        <path fill="#002A7D" d="M122.6 370.2h61.3v61.3l-61.3-61.3z" />
        <path
          fill="#10102B"
